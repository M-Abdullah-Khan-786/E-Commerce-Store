    ...
    <>
      ...
      <div className="d-flex justify-content-between align-items-center gap-3">
        <div className="d-flex justify-content-between align-items-center flex-grow-1 bg-white p-3 rounded-3">
          <div>
            <p className="mb-0 content">Total</p> <h4 className="mb-0 sub-title">Rs 2200</h4>
          </div>
          <div className="d-flex flex-column align-items-end">
            <h6 className="black">
              <FiArrowDownRight /> 22%
            </h6>
            <p className="mb-0 content">Compare to Last Month</p>
          </div>
        </div>
        <div className="d-flex justify-content-between align-items-center flex-grow-1 bg-white p-3 rounded-3">
          <div>
      ...
      <div className="mt-4">
        <h3 className="mb-4 content">Income Stats</h3>
        <div>
          <Column {...config} />
        </div>
      </div>
