...
const AddBlog = () => {
  ...
  return (
   ...
   <div>
    <form action="">
        <CustomInput type="text" placeholder="Blog Title" className="w-100 p-3 border-0"/>
      ...
      />
      <button className="btn btn-warning border-0 rounded-3 my-4 float-end me-4" type="submit">Add Blog</button>
    </form>
   </div>
   </>
  )
